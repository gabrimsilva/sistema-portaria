...
class PreCadastrosPrestadoresController {
     ...
     * GET /api/pre-cadastros/prestadores/search?q=termo
     */
     ...
     * POST /pre-cadastros/prestadores-servico?action=upload_foto
     */
    public function uploadFoto() {
        ...
        try {
            ...
            // Nome do arquivo
            $filename = 'prestador_' . $cadastro_id . '_' . time() . '.' . $extension;
            ...
            $foto_url = '/uploads/prestadores/' . $filename;
            $this->db->query(
                "UPDATE prestadores_cadastro SET foto_url = ? WHERE id = ?",
    ...
    /**
     * Buscar prestador por documento (autocomplete)
     */
