...
class AuthorizationService {
    ...
    private const PERMISSIONS = [
        'administrador' => [
            ...
            'config.rbac.write',
            'config.manage',
            'config.retention.write',
            'config.retention.delete',
            'config.retention.restore',
            'config.retention.anonymize',
            'admin.system.manage',
            'pre_cadastros.read',
            ...
            'relatorios.editar_linha',
            'relatorios.excluir_linha',
            'relatorios.exportar',
            'documentos.manage',
            'profissionais_renner.excluir',
